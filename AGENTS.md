...
- Emoji, Unicode symbols, native Markdown/HTML, a few lightweight animated emoji, and one non-critical ambient public gradient strip are acceptable when they add personality rather than decoration.
