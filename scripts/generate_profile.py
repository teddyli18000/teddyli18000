...
`stats-organization/github-readme-stats-action` workflow. This script owns the
profile-specific upstream PR list, visible refresh timestamp, and footer rotation.
"""
